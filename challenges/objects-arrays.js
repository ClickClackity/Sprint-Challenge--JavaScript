...
const unisWithUni = graduates.map(grad => grad.university).filter(universe => (universe.includes('Uni')));
...
*/
const populationTotal = zooAnimals.reduce((total, animalAmount) => total += animalAmount.population, 0);
